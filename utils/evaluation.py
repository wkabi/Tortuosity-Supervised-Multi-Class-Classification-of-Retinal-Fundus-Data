    ...
    if print_conf:
        if text_file is not None:
            ...
            if len(class_names)==3:
                ...
                print('\nAUC: Unclass0={:.2f} - Normal1={:.2f} - Mild2={:.2f} - Severe3={:.2f}'.format(
                    100 * auc_all[0], 100 * auc_all[1], 100 * auc_all[2], 100 * auc_all[3]), end=" ", file=open(text_file, "a"))
            elif len(class_names)==5:
                print('\nAUC: Unclass0={:.2f} - Normal1={:.2f} - Mild2={:.2f} - Moderate3={:.2f} - Severe4={:.2f}'.format(
